...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="<?php echo is_active('appointment'); ?> nav-item">
        <a href="javascript:;"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Appointment">Appointment</span></a>
        <ul class="menu-content">
          <li class="<?php echo is_active('appointment'); ?>"><a href="?page=appointment"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Daftar Appointment">Daftar Appointment</span></a>
          </li>
          <li class="<?php echo is_active('queue-management'); ?>"><a href="?page=queue-management"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Queue Management">Queue Management</span></a>
          </li>
        </ul>
      </li>
