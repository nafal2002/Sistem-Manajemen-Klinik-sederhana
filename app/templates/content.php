...
if (isset($_GET['page'])) {
	...
	switch ($_GET['page']) {
		...
		case 'lap-rekam-medis':
			...
			break;
		case 'appointment':
			require_once 'app/appointment/views/index.php';
			break;
		case 'tambah-appointment':
			require_once 'app/appointment/views/create.php';
			break;
		case 'queue-management':
			require_once 'app/appointment/views/queue.php';
			break;
	}
} else {
