...
- **Manajemen Dokter** - Kelola profil dokter, spesialisasi, dan kontak
- **Manajemen Pasien** - Kelola data pasien dan informasi demografis
- **Manajemen Ruang** - Kelola ruang/bangsal klinik
- **Manajemen Obat** - Kelola inventori obat dan keterangan
- **Rekam Medis** - Catat kunjungan pasien, diagnosa, dan resep obat
- **Laporan** - Generate laporan rekam medis
...
1. **Copy project** ke folder web server:
   ...
   ```
   (atau sesuai lokasi htdocs Anda)
...
**Catatan**: Aplikasi ini masih dalam tahap pengembangan dan tidak disarankan untuk digunakan di lingkungan production tanpa perbaikan keamanan yang memadai.#   S i s t e m - M a n a j e m e n - K l i n i k - s e d e r h a n a  
 